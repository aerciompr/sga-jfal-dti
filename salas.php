...
// Proteção de Acesso: Apenas administradores e recepcionistas podem acessar este módulo
...
<body class="bg-gray-950 text-gray-100 min-h-screen flex flex-col">
    ...
    <header class="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center justify-between shadow-md">
        <div class="flex items-center space-x-3">
            ...
            <span class="bg-gray-800 text-gray-400 text-xs px-2.5 py-1 rounded-full uppercase font-semibold">Salas de Atendimento</span>
        </div>
